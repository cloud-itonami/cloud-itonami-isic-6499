# Operator Quickstart — Other financial service activities, except insurance and pension funding, n.e.c. (venture capital fund)

Shortest path from clone to a verified local dry-run for **ISIC 6499** (`cloud-itonami-isic-6499`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-6499.git
cd cloud-itonami-isic-6499
```
...
- Blueprint governor key: `investment-committee-governor`
- Likely source path: `vcfund.governor.cljc`
